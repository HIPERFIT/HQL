...
\vskip 0.5\FrameSep
\begin{lstlisting}
HQL> let discreteRate = InterestRate (Exponential Annually 5.0)
\end{lstlisting}
\vskip 0.5\FrameSep
...
%% ============================================================================================
	...
	doinside=\small
	  ...
	  \toprule
		HQL & Meaning \\
	  \midrule
		\ttfamily{Continuous} & Continuous compounding\\
		\ttfamily{Exponential} & Discrete compounding\\
		\ttfamily{Linear} & Linear or simple compounding\\
	  \bottomrule
	}
	...
	\subsection{Example 2 - Compounding frequencies}
