...
Future value of a nominal cash flow $N$ discretely compounding,
\[ FV = N(1+r)^n \]
Present value of a nominal future cash flow $N$,
\[ PV = \frac{N}{(1+r)^n} \]

Discrete or periodic compounding where n is the number of compounding per period and m is number of periods ($m=nT$),
\[ 
FV=N\left( 1 + \frac{R}{n}  \right)^m
\]
